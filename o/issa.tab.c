...
#ifndef YY_YY_ISSA_TAB_H_INCLUDED
# define YY_YY_ISSA_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 1
#endif
...
#endif /* !YY_YY_ISSA_TAB_H_INCLUDED  */
/* Symbol kind.  */
...
#line 37 "src/issa.y"
                                 { printf("\tResult: %f\n", (yyvsp[-1].fval));}
#line 1171 "issa.tab.c"
    break;

  case 6:
#line 38 "src/issa.y"
                           { printf("\tResult: %i\n", (yyvsp[-1].ival)); }
#line 1177 "issa.tab.c"
    break;

  case 7:
#line 39 "src/issa.y"
                       { printf("bye!\n"); exit(0); }
#line 1183 "issa.tab.c"
    break;

  case 8:
#line 42 "src/issa.y"
                                                         { (yyval.fval) = (yyvsp[0].fval); }
#line 1189 "issa.tab.c"
    break;

  case 9:
#line 43 "src/issa.y"
                                                         { (yyval.fval) = (yyvsp[-2].fval) + (yyvsp[0].fval); }
#line 1195 "issa.tab.c"
    break;

  case 10:
#line 44 "src/issa.y"
                                                         { (yyval.fval) = (yyvsp[-2].fval) - (yyvsp[0].fval); }
#line 1201 "issa.tab.c"
    break;

  case 11:
#line 45 "src/issa.y"
                                                     { (yyval.fval) = (yyvsp[-2].fval) * (yyvsp[0].fval); }
#line 1207 "issa.tab.c"
    break;

  case 12:
#line 46 "src/issa.y"
                                                         { (yyval.fval) = (yyvsp[-2].fval) / (yyvsp[0].fval); }
#line 1213 "issa.tab.c"
    break;

  case 13:
#line 47 "src/issa.y"
                                                 { (yyval.fval) = (yyvsp[-1].fval); }
#line 1219 "issa.tab.c"
    break;

  case 14:
#line 48 "src/issa.y"
                                                         { (yyval.fval) = (yyvsp[-2].ival) + (yyvsp[0].fval); }
#line 1225 "issa.tab.c"
    break;

  case 15:
#line 49 "src/issa.y"
                                                         { (yyval.fval) = (yyvsp[-2].ival) - (yyvsp[0].fval); }
#line 1231 "issa.tab.c"
    break;

  case 16:
#line 50 "src/issa.y"
                                                 { (yyval.fval) = (yyvsp[-2].ival) * (yyvsp[0].fval); }
#line 1237 "issa.tab.c"
    break;

  case 17:
#line 51 "src/issa.y"
                                                 { (yyval.fval) = (yyvsp[-2].ival) / (yyvsp[0].fval); }
#line 1243 "issa.tab.c"
    break;

  case 18:
#line 52 "src/issa.y"
                                                         { (yyval.fval) = (yyvsp[-2].fval) + (yyvsp[0].ival); }
#line 1249 "issa.tab.c"
    break;

  case 19:
#line 53 "src/issa.y"
                                                         { (yyval.fval) = (yyvsp[-2].fval) - (yyvsp[0].ival); }
#line 1255 "issa.tab.c"
    break;

  case 20:
#line 54 "src/issa.y"
                                                 { (yyval.fval) = (yyvsp[-2].fval) * (yyvsp[0].ival); }
#line 1261 "issa.tab.c"
    break;

  case 21:
#line 55 "src/issa.y"
                                                 { (yyval.fval) = (yyvsp[-2].fval) / (yyvsp[0].ival); }
#line 1267 "issa.tab.c"
    break;

  case 22:
#line 56 "src/issa.y"
                                                 { (yyval.fval) = (yyvsp[-2].ival) / (float)(yyvsp[0].ival); }
#line 1273 "issa.tab.c"
    break;

  case 23:
#line 59 "src/issa.y"
                                                { (yyval.ival) = (yyvsp[0].ival); }
#line 1279 "issa.tab.c"
    break;

  case 24:
#line 60 "src/issa.y"
                                        { (yyval.ival) = (yyvsp[-2].ival) + (yyvsp[0].ival); }
#line 1285 "issa.tab.c"
    break;

  case 25:
#line 61 "src/issa.y"
                                        { (yyval.ival) = (yyvsp[-2].ival) - (yyvsp[0].ival); }
#line 1291 "issa.tab.c"
    break;

  case 26:
#line 62 "src/issa.y"
                                                { (yyval.ival) = (yyvsp[-2].ival) * (yyvsp[0].ival); }
#line 1297 "issa.tab.c"
    break;

  case 27:
#line 63 "src/issa.y"
                                                { (yyval.ival) = (yyvsp[-1].ival); }
#line 1303 "issa.tab.c"
    break;


#line 1307 "issa.tab.c"
